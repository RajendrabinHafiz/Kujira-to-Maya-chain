...
import (
	...
	appparams "gitlab.com/mayachain/mayanode/app/params"
	"gitlab.com/mayachain/mayanode/x/mayachain"
	thorchainkeeper "gitlab.com/mayachain/mayanode/x/mayachain/keeper"
...
var (
	...
	maccPerms = map[string][]string{
		...
		mayachain.ModuleName:           {authtypes.Minter, authtypes.Burner},
		mayachain.AsgardName:           {},
		mayachain.BondName:             {},
		mayachain.ReserveName:          {},
		mayachain.MayaFund:             {},
	}
...
var (
	_ App                     = (*BASEChainApp)(nil)
	_ servertypes.Application = (*BASEChainApp)(nil)
)
...
func New(
	...
	app.thorchainKeeper = thorchainkeeper.NewKeeper(
		appCodec, app.BankKeeper, app.AccountKeeper, app.TransferKeeper, keys[thorchaintypes.StoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		mayachain.NewAppModule(app.thorchainKeeper, appCodec, app.BankKeeper, app.AccountKeeper, app.TransferKeeper, keys[thorchaintypes.StoreKey], telemetryEnabled),
	)
...
func (app *BASEChainApp) Name() string { return app.BaseApp.Name() }
