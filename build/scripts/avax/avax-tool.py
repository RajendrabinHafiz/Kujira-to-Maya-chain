...
class TestAvalanche:
    ...
    def swap_in(self):
        ...
        # add_liq_memo = "ADD:AVAX.AVAX:tmaya1uuds8pd92qnnq0udw0rpg0szpgcslc9p8gps0z"
        swap_memo = "SWAP:MAYA.CACAO:tmaya1uuds8pd92qnnq0udw0rpg0szpgcslc9p8gps0z"
...
def main():
    ...
    if args.name == "deposit_tkn":
        ...
        test_avalanche.deposit_tkn(
            1000000000000000000,
            "ADD:AVAX.TKN-0X333C3310824B7C685133F2BEDB2CA4B8B4DF633D:tmaya1uuds8pd92qnnq0udw0rpg0szpgcslc9p8gps0z",
        )
