...
// GasMgrV98 implement GasManager interface which will store the gas related events happened in thorchain to memory
...
// newGasMgrV98 create a new instance of GasMgrV98
func newGasMgrV98(constantsAccessor constants.ConstantValues, k keeper.Keeper) *GasMgrV98 {
	return &GasMgrV98{
...
func (gm *GasMgrV98) GetFee(ctx cosmos.Context, chain common.Chain, asset common.Asset) cosmos.Uint {
	...
	if (asset.IsBase() && chain.Equals(common.BASEChain)) || (asset.Equals(common.RUNEAsset) && chain.Equals(common.THORChain)) {
...
func (gm *GasMgrV98) getRuneInAssetValue(ctx cosmos.Context, transactionFee cosmos.Uint, asset common.Asset) cosmos.Uint {
	if asset.IsSyntheticAsset() {
