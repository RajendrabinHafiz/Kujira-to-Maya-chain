...
// newSlasherV104 create a new instance of Slasher
func newSlasherV104(keeper keeper.Keeper, eventMgr EventManager) *SlasherV104 {
	return &SlasherV104{keeper: keeper, eventMgr: eventMgr}
}
...
func (s *SlasherV104) slashNotObserving(ctx cosmos.Context, txHash common.TxID, constAccessor constants.ConstantValues) error {
...
func (s *SlasherV104) checkSignerAndSlash(ctx cosmos.Context, nodes NodeAccounts, blockHeight int64, signers []cosmos.AccAddress, constAccessor constants.ConstantValues) {
...
func (s *SlasherV104) needsNewVault(ctx cosmos.Context, mgr Manager, nas int, signingTransPeriod, startHeight int64, inhash common.TxID, pk common.PubKey) bool {
