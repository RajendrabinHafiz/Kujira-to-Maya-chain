...
import (
	...
	gitlab_com_thorchain_thornode_common "gitlab.com/mayachain/mayanode/common"
...
func (h QueryResLastBlockHeights) String() string {
	return fmt.Sprintf("Chain: %d, Signed: %d, BASEChain: %d", h.LastChainHeight, h.LastSignedHeight, h.Mayachain)
}
