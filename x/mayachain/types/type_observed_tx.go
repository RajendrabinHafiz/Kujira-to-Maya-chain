...
// matchActionItem is to check the given outboundTx against the list of actions, return true if the outboundTx matched any of the actions
...
// IsDone check whether BASEChain finished process the tx, all outbound tx had
