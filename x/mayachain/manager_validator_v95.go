...
func (vm *validatorMgrV95) payNodeAccountBondAward(ctx cosmos.Context, lastChurnHeight int64, na NodeAccount, totalBondReward, totalEffectiveBond, bondHardCap cosmos.Uint, mgr Manager, liquidityBond sdk.Uint) error {
	...
	reward := common.GetUncappedShare(liquidityBond, totalEffectiveBond, totalBondReward)
