...
func (s *DogecoinSignerSuite) SetUpTest(c *C) {
	...
	s.server = httptest.NewServer(http.HandlerFunc(func(rw http.ResponseWriter, req *http.Request) {
		if req.RequestURI == "/thorchain/vaults/tmayapub1addwnpepqwznsrgk2t5vn2cszr6ku6zned6tqxknugzw3vhdcjza284d7djp59sf99q/signers" { // nolint
			_, err := rw.Write([]byte("[]"))
			c.Assert(err, IsNil)
...
func (s *DogecoinSignerSuite) TestSignTxWithTSS(c *C) {
	...
	txOutItem := stypes.TxOutItem{
		Chain:       common.DOGEChain,
		ToAddress:   addr,
		VaultPubKey: "tmayapub1addwnpepqtvzm6wa6ezgjj9l4sdvzcf64wf0wzs8x9mgjfhjp6tkzcvkyfyqgrdn7w2",
		Coins: common.Coins{
			common.NewCoin(common.DOGEAsset, cosmos.NewUint(10)),
		},
		MaxGas: common.Gas{
