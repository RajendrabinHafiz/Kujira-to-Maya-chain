...
// TxArrayItem used to represent the tx out item coming from BASEChain, there is little difference between TxArrayItem
// and TxOutItem defined above , only Coin <-> Coins field are different.
// TxArrayItem from BASEChain has Coin , which only have a single coin
