...
class TestMayachainState(unittest.TestCase):
    ...
    def test_handle_fee(self):
        ...
        self.assertEqual(mayachain.reserve, 1348821)
    ...
    def test_swap_bep2(self):
        ...
        outbound = mayachain.handle(tx)
        self.assertEqual(len(outbound), 0)
        self.assertEqual(mayachain.pools[0].cacao_balance, 5999686468)
        ...
        expected_events += [
            ...
            Event(
                ...
                [
                    ...
                    {"liquidity_fee_in_cacao": "35504528"},
    ...
    def test_swap_native(self):
        ...
        self.assertEqual(len(outbound), 1)
        self.assertEqual(outbound[0].memo, "OUT:TODO")
        self.assertEqual(outbound[0].coins[0], Coin("BNB.BNB", 226644869))
        ...
        self.assertEqual(outbound[0].coins[0], Coin("BNB.LOK-3C0", 997525501))
        ...
        outbound = mayachain.handle(tx)
        self.assertEqual(len(outbound), 0)
        self.assertEqual(mayachain.pools[0].cacao_balance, 104995050768)
        ...
        # check refund event generated for swap with limit
        reason = "emit asset 1043126918 less than price limit 999999999999999999999"
        expected_events += [
            Event(
                "refund",
                [{"code": "108"}, {"reason": reason}, *tx.get_attributes()],
        ...
        expected_events += [
            Event(
                ...
                [
                    ...
                    {"swap_target": "0"},
                    {"swap_slip": "47"},
                    {"liquidity_fee": "107228"},
                    {"liquidity_fee_in_cacao": "2358539"},
                    {"emit_asset": "22516902 BNB.BNB"},
                    *tx.get_attributes(),
                ],
            ),
            Event(
    ...
    def test_withdraw_native(self):
        ...
        pool = mayachain.get_pool("BNB.BNB")
        self.assertEqual(pool.cacao_balance, 5444879857020)
        self.assertEqual(pool.asset_balance, 5098612500)
        self.assertEqual(pool.get_liquidity_provider(
        ...
        self.assertEqual(outbounds[1].coins[0],
                         Coin("MAYA.CACAO", 5442879857020))
